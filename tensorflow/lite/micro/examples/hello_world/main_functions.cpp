...
const int kModelArenaSize = 3192;
// Extra headroom for model + alignment + future interpreter changes.
const int kExtraArenaSize = 560 + 16 + 100;
const int kTensorArenaSize = kModelArenaSize + kExtraArenaSize;
uint8_t tensor_arena[kTensorArenaSize];

const char class_names[][10] = {"Clouds", "Rain", "Clear", "Snow"};
const uint8_t NUM_CLASSES = 4;
...
// The name of this function is important for Arduino compatibility.
void nn_inference(measurement_t *measurement, predictions_t *pred) {
  ...
  //HandleOutput(error_reporter, pred->clouds, pred->clear, pred->rain);
}
